...
|----------|--------|--------|
| Interface type | Tkinter desktop GUI | Existing — SFI Reporter is a Tkinter app |
...
| User type | Non-technical end users (managers) | Existing — SFI Reporter targets engineering managers |
