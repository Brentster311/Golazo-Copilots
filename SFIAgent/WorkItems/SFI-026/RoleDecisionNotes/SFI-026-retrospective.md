...
| # | Action | Priority |
|---|--------|----------|
| 1 | Document lazy-import patch targets in a `TESTING.md` for SFIReporter (e.g., "always patch `sfi_reporter.data.get_client`, not `sfi_reporter.tk_app.get_client`") | Medium |
