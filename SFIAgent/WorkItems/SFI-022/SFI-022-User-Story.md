...
- **Assumption (explicit)**: SFI-020 (core Analyze with LLM + save to disk) is already implemented — saved analyses exist as JSON files under `%LOCALAPPDATA%/sfireporter/analyses/`
