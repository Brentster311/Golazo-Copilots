...
Add colored circle indicators to section headers in the SFI Reporter detail modal to match the visual design of the sidebar list view. This is a low-risk cosmetic fix that improves UI consistency.
...
- **Product Owner**: SFI Reporter team (approves cosmetic changes)
...
2. Include in next SFI Reporter release (v0.2.1 or v0.3.0)
...
### Related Files
- `SFIReporter/src/sfi_reporter/tk_app.py` (DetailWindow, modal builder)
- `SFIReporter/src/sfi_reporter/flet_app.py` (Flet version, out of scope)
