...
## Problem Statement
The current s360_client code exists only within this repository. Other projects (like SFIReporter) cannot easily consume it without copying files, which leads to:
...
### Why Now
- SFI-003 (SFIReporter) requires s360_client as a dependency
