...
- **Acceptance Criteria** (bulleted, testable):
  - `tk_app.py` is deleted from `SFIReporter/src/sfi_reporter/`
  - `pyproject.toml` entry point is updated from `sfi_reporter.tk_app:main` → `sfi_reporter.app:main`
  - Both `.spec` files (`SFIReporter.spec`, `build/SFIReporter.spec`) reference `app.py` instead of `tk_app.py`
...
| File | Change |
|---|---|
| `SFIReporter/src/sfi_reporter/tk_app.py` | DELETE |
| `SFIReporter/pyproject.toml` | Entry point → `sfi_reporter.app:main` |
| `SFIReporter/SFIReporter.spec` | Analysis target → `app.py` |
| `SFIReporter/build/SFIReporter.spec` | Analysis target → `app.py` |
| `SFIReporter/src/sfi_reporter/query_builder.py` | Retarget 2 imports |
| `SFIReporter/_diagnose.py` | Retarget imports |
| `SFIReporter/_diag2.py` | Retarget import |
| `SFIReporter/tests/test_tk_app.py` | Retarget all imports + patch paths |
| `SFIReporter/tests/test_detail_modal_colors.py` | Retarget imports |
| `SFIReporter/tests/test_sfi_023.py` | Retarget imports |
| `SFIReporter/tests/test_sfi_024.py` | Retarget imports |
| `SFIReporter/tests/test_sfi_026.py` | Retarget imports |
| `SFIReporter/tests/test_sfi_026_live.py` | Retarget imports |
