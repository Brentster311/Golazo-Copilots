...
## Summary
Add double-click drill-down functionality to all three tables in SFI Reporter (Services, Programs, Action Items) that opens a modal dialog showing filtered action item details.
...
## Stakeholders
- SFI Reporter users (brentj and team)
