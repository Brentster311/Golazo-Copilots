...
- **Date**: 2026-02-06
- **Build command**: `python -m pytest SFIReporter/tests/ --rootdir=SFIReporter -v --tb=short`
- **Result**: 84 tests passed, 1 warning
- **PyInstaller build**: `pyinstaller --onefile --name SFIReporter src/sfi_reporter/tk_app.py` — 18.7 MB exe built successfully
