...
- **As a**: SFI Reporter user analyzing a KPI with the "Analyze with LLM" feature
...
- **Assumptions**:
  ...
  - **Assumption (explicit)**: Target platform is Windows (matching the existing SFIReporter build target).
