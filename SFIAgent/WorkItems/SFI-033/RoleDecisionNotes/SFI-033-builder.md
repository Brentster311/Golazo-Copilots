...
## Notes
- PyInstaller spec (`SFIReporter.spec`) may need updating on next `reporter-build` to reflect removed `llm-extender`/`openai` hidden imports and added `copilot_panel` module
