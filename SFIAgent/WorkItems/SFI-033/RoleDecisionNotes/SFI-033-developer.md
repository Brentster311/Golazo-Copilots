...
**Files deleted:**
- `SFIReporter/src/sfi_reporter/llm_client.py` (419 lines — Azure OpenAI client)
- `SFIReporter/src/sfi_reporter/llm_storage.py` (analysis result storage)
- `SFIReporter/tests/test_llm_client.py`
- `SFIReporter/tests/test_llm_storage.py`
- `SFIReporter/tests/test_sfi_025.py` (ConfigureLLMDialog tests)
- `SFIReporter/docs/analyze-with-llm.md`
...
- System/light theme (matches SFI Reporter, not dark ghcpsdk theme)
