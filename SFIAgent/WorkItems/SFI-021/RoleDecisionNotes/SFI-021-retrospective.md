...
2. **Working directory confusion with git**: `git add .` from SFIReporter subdirectory didn't stage WorkItems files (at parent level). Had to use `git add -A` from repo root.
