...
| A3 | **No changes to `s360_client/auth.py`** | That module is the older standalone client — SFI Reporter uses `accia-s360` exclusively. Leave it as-is to avoid scope creep. |
