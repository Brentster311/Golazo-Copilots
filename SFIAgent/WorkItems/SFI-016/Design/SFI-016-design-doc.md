...
## Summary
Introduce a singleton `S360Client` pattern and a "Retry Failed KPIs" UI feature to improve resilience and user visibility during KPI data fetching in SFI Reporter.
...
## Stakeholders
- SFI Reporter end users (Microsoft engineers using S360 dashboards)
- SFI Reporter maintainers
...
- All in existing rotating log at `%TEMP%/sfireporter/sfi_reporter.log`
