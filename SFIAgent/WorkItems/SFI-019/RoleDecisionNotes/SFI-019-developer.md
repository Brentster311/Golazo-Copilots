...
| File | Purpose |
|------|---------|
| `SFIReporter/src/sfi_reporter/eta_logic.py` | Pure functions: `propose_eta()`, `get_items_needing_eta_update()`, `validate_eta_date()`, `build_eta_update()` |
| `SFIReporter/tests/test_eta_logic.py` | 5 tests (TC-01 through TC-05) |
| `SFIReporter/tests/test_eta_ui.py` | 9 tests (TC-09 through TC-15 + 2 bonus) |
...
| `SFIReporter/src/sfi_reporter/tk_app.py` | 4 dialog classes + 2 buttons + post-save cache refresh |
