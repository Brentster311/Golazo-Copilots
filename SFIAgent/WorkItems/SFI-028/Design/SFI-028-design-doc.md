# SFI-028 Design Doc — Replace S360 Chain-Walking with MS Graph in SFIReporter
...
## Files Changed
- `SFIReporter/src/sfi_reporter/tk_app.py`: Rewrite `get_org_mapping()`, update `get_service_owners()` to return aliases
