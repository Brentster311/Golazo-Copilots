"""Logging configuration and platform fixes for SFI Reporter.

Sets up file-based logging to %TEMP%/sfireporter/sfi_reporter.log
...
LOG_DIR = Path(tempfile.gettempdir()) / "sfireporter"
...
def setup_logging(level: int = logging.DEBUG) -> None:
    """Configure logging for the entire sfi_reporter package.
    ...
    root = logging.getLogger("sfi_reporter")
...
def patch_subprocess_windows() -> None:
    ...
    logging.getLogger("sfi_reporter").debug(
