...
class TestBulkUpdateFlow:
    ...
    def test_tc09_all_items_updated(self):
        ...
        from sfi_reporter.eta_logic import get_items_needing_eta_update, propose_eta, build_eta_update
...
class TestSingleItemUpdate:
    ...
    def test_tc12_single_update_builds_correct_payload(self):
        ...
        from sfi_reporter.eta_logic import build_eta_update
...
class TestDateValidation:
    ...
    def test_tc14_past_date_rejected(self):
        ...
        from sfi_reporter.eta_logic import validate_eta_date
