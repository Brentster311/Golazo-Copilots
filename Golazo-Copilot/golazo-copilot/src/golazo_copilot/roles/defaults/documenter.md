...
- **Do not approve documentation that describes unsupported features** - cross-reference README claims against `.github/agents/Golazo-Copilot.md` and actual code
