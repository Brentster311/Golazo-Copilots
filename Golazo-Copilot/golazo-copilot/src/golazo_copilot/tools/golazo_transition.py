...
from .golazo_consent import consume_consent, has_valid_consent
    ...
    if not check_role_notes_exist(work_item_id, current_role, work_items_dir):
        ...
        if force_without_notes:
            ...
            return {
                ...
                "hint": "Create the file first, or use force_without_notes=True with prior golazo_consent(action='skip_role')",
            }
