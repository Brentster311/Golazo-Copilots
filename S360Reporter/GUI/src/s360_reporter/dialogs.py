"""Tkinter dialog classes and reusable widgets for S360Reporter."""
import logging
import threading
...
from s360_reporter.formatters import (
...
from s360_reporter.services import _load_setting, _save_setting
...
class SingleEtaEditDialog(tk.Toplevel):
    ...
    def _on_save(self):
        ...
        from s360_reporter.data import get_client, get_current_user_alias
...
class BulkEtaProgressDialog(tk.Toplevel):
    ...
    def _run_bulk(self):
        from s360_reporter.eta_logic import propose_eta, build_eta_update
        from s360_reporter.data import get_client, get_current_user_alias
...
def _launch_llm_analysis(parent, item: dict):
    ...
    def _bg_analyze():
        from s360_reporter.kpi_analyzer import analyze_kpi
        try:
