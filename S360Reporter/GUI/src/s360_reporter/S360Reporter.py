...
from s360_reporter.logging_config import setup_logging, get_log_path, patch_subprocess_windows
from s360_reporter.models import OrgAncestry
from s360_reporter.services import (
...
from s360_reporter.dialogs import (
...
class SFIReporterApp:
    ...
    def _build_ui(self):
        ...
        header_label = ttk.Label(main_frame, text="\U0001f4ca S360Reporter", font=("Segoe UI", 20, "bold"))
    ...
    def _on_retry_failed(self):
        ...
        def retry_in_background():
            from s360_reporter.data import get_detailed_action_items, is_invalid_eta
            from datetime import datetime
    ...
    def _on_query(self):
        from s360_reporter.query_builder import QueryBuilder
    ...
    def _reapply_last_filter(self):
        from s360_reporter.query_builder import evaluate_clauses
        source = self._unfiltered_data or self.current_data
    ...
    def _on_filter_applied(self, filtered_items: list, clauses: list):
        ...
        from s360_reporter.query_builder import load_clause_cache
    ...
    def _toggle_copilot_panel(self):
        ...
        if self._copilot_panel is None:
            from s360_reporter.copilot_panel import CopilotPanel
...
def main():
    ...
    logger.info("S360Reporter starting \u2014 log file: %s", get_log_path())
