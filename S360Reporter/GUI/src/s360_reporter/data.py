...
def get_column_cache_path() -> str:
    ...
    Returns:
        Absolute path to column_metadata.json in $TEMP/GUI/
    """
    cache_dir = os.path.join(os.environ.get('TEMP', '/tmp'), 'S360Reporter')
...
def get_client() -> Any:
    ...
    if _client_instance is None:
        ...
        from s360_reporter.cache import get_cache_dir
