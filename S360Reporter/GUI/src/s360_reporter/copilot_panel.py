"""Copilot chat side panel for S360Reporter.
...
The panel matches the system/light theme of S360Reporter.
"""
import asyncio
import logging
import re
...
class CopilotPanel(tk.Frame):
    ...
    # System/light theme colours (matches S360Reporter)
    BG_COLOR = "#f0f0f0"
    FG_COLOR = "#1e1e1e"
    INPUT_BG = "#ffffff"
    CHAT_BG = "#ffffff"
    ...
    async def _ensure_connected(self):
        ...
        try:
            ...
            if self._app is not None:
                from s360_reporter.copilot_tools import build_tools, SYSTEM_MESSAGE
    ...
    def _do_send_analysis(self, prompt: str, kpi_label: str = "", sources_metadata=None):
        ...
        if sources_metadata is not None:
            ...
            if docs_dir:
                from s360_reporter.copilot_tools import set_current_docs_dir
    ...
    def _show_sources_card(self, result):
        ...
        """
        try:
            from s360_reporter.kpi_analyzer import format_sources_card
