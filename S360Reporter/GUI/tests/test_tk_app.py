...
class TestDataFetching:
    ...
    def test_refresh_success(self, mocker):
        ...
        mocker.patch('s360_reporter.data.get_client', return_value=mock_client)
        
        mock_team_info = mocker.patch('s360_reporter.data.get_user_team_info')
        mock_action_items = mocker.patch('s360_reporter.data.get_action_items_summary')
        mock_detailed = mocker.patch('s360_reporter.data.get_detailed_action_items')
        mock_programs = mocker.patch('s360_reporter.data.get_all_programs')
        mock_write = mocker.patch('s360_reporter.services.write_cache')
        ...
        from s360_reporter.services import do_refresh
...
class TestDetailModal:
    ...
    def test_filter_by_service(self):
        ...
        from s360_reporter.services import filter_items_by_service
    ...
    def test_filter_by_program(self):
        ...
        from s360_reporter.services import filter_items_by_program
    ...
    def test_filter_by_item_id(self):
        ...
        from s360_reporter.services import filter_items_by_id
...
class TestItemDetailsModal:
    ...
    def test_format_field_label_snake_case(self):
        ...
        from s360_reporter.formatters import format_field_label
    ...
    def test_format_field_value_string(self):
        ...
        from s360_reporter.formatters import format_field_value
    ...
    def test_group_item_fields(self):
        ...
        from s360_reporter.formatters import group_item_fields
...
class TestUrlExtraction:
    ...
    def test_extract_plain_urls(self):
        ...
        from s360_reporter.formatters import extract_urls_from_text
    ...
    def test_clean_html_from_title(self):
        ...
        from s360_reporter.formatters import clean_html_from_title
    ...
    def test_parse_resource_uris_json_string(self):
        ...
        from s360_reporter.formatters import parse_resource_uris
...
class TestSortableTreeview:
    ...
    def test_sort_by_columns_numeric(self):
        ...
        from s360_reporter.dialogs import SortableTreeview
...
class TestColumnToggle:
    ...
    def test_required_columns_defined(self):
        ...
        from s360_reporter.models import REQUIRED_COLUMNS
    ...
    def test_get_available_columns(self):
        ...
        from s360_reporter.models import get_available_columns
    ...
    def test_filter_item_columns(self):
        ...
        from s360_reporter.models import filter_item_columns
    ...
    def test_select_all_columns(self):
        ...
        from s360_reporter.models import select_all_columns
    ...
    def test_clear_all_keeps_required(self):
        ...
        from s360_reporter.models import clear_all_columns, REQUIRED_COLUMNS
    ...
    def test_validate_visible_columns(self):
        ...
        from s360_reporter.models import validate_visible_columns, REQUIRED_COLUMNS
    ...
    def test_column_display_names(self):
        ...
        from s360_reporter.models import COLUMN_DISPLAY_NAMES
...
class TestEmptyColumnDetection:
    ...
    def test_get_empty_columns_none_value(self):
        ...
        from s360_reporter.models import get_empty_columns
...
class TestManagerDetection:
    ...
    def test_is_manager_view_true_for_team_group(self):
        ...
        from s360_reporter.services import is_manager_view
...
class TestServiceOwnerLookup:
    ...
    def test_get_service_owners_single_owner(self):
        ...
        from s360_reporter.services import parse_owners_field
...
class TestOwnerAggregation:
    ...
    def test_aggregate_by_owner_single_owner(self):
        ...
        from s360_reporter.services import aggregate_by_owner
...
class TestDirectReportFiltering:
    ...
    def test_extract_direct_reports_from_team_entries(self):
        ...
        from s360_reporter.services import extract_direct_reports
