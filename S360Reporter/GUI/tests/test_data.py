...
import pytest
import s360_reporter.data as data_module
...
class TestUserDetection:
    ...
    def test_auto_detect_user(self, mocker):
        ...
        # Mock S360Client
        mock_client_class = mocker.patch('s360_reporter.data.S360Client')
        ...
        from s360_reporter.data import get_current_user_alias
...
class TestServiceFetching:
    ...
    def test_fetch_user_services(self, mocker):
        ...
        from s360_reporter.data import get_user_services
...
class TestActionItemFetching:
    ...
    def test_fetch_action_items(self, mocker):
        ...
        from s360_reporter.data import get_action_items_summary
...
class TestColumnMetadataCache:
    ...
    def test_column_cache_path(self):
        """TC01: Column metadata cache is at $TEMP/GUI/column_metadata.json"""
        from s360_reporter.data import get_column_cache_path
        import os
        path = get_column_cache_path()
        assert "S360Reporter" in path
    ...
    def test_load_column_cache_when_missing(self, tmp_path, monkeypatch):
        ...
        from s360_reporter.data import load_column_cache
    ...
    def test_save_and_load_column_cache(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("s360_reporter.data.get_column_cache_path", lambda: cache_path)
        
        from s360_reporter.data import save_column_cache, load_column_cache
    ...
    def test_get_cached_columns_hit(self, tmp_path, monkeypatch):
        ...
        from s360_reporter.data import save_column_cache, get_cached_columns
    ...
    def test_essential_columns_always_included(self):
        ...
        from s360_reporter.data import ESSENTIAL_COLUMNS, merge_columns_with_essentials
    ...
    def test_cache_kpi_columns(self, tmp_path, monkeypatch):
        ...
        from s360_reporter.data import cache_kpi_columns, get_cached_columns
