...
class TestDrillDownSubtree:
    ...
    def test_level1_drilldown_collects_entire_subtree(self):
        ...
        from s360_reporter.models import OrgAncestry
        from s360_reporter.services import collect_services_for_owner
...
class TestCacheSerializationRoundTrip:
    ...
    def test_org_mapping_round_trip(self):
        from s360_reporter.models import OrgAncestry
        from s360_reporter.services import _serialize_org_data_for_cache, _deserialize_org_data_from_cache
        data = {
            'org_mapping': {
    ...
    def test_legacy_string_org_mapping_preserved(self):
        ...
        from s360_reporter.services import _deserialize_org_data_from_cache
        data = {
