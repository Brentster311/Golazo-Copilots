...
- **As a**: skip-level manager (e.g. alexhowells) viewing S360Reporter
...
- **Rollout**: Ship as part of next S360Reporter PyInstaller build. No config changes needed — the algorithm auto-detects hierarchy depth.
