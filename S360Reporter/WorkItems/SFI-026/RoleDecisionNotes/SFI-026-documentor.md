...
The S360Reporter README does not describe internal data model details or org hierarchy behavior, so no external documentation update is required. The feature is a user-visible behavior change in the Tkinter UI, not an API change.
