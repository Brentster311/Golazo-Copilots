...
- **Title**: Move org-tree cache from S360Reporter into accia-s360's `_build_subtree`
...
- **Acceptance Criteria (bulleted, testable)**:
  ...
  - [ ] Existing accia-s360 tests pass unchanged; existing S360Reporter tests pass (including SFI-029, SFI-031 tests)
