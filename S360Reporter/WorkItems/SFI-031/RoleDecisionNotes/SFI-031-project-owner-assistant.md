...
2. **Data persistence**: Reuse existing file-based cache directory (`get_cache_dir()` → `tempdir/GUI/`). Separate file from the main user cache to avoid coupling lifecycles.
