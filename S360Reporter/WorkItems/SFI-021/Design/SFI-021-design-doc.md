...
This avoids reimplementing URL fetching logic in S360Reporter.
...
| File | Change |
|------|--------|
| `pyproject.toml` | Add `llm-extender>=0.1.0` dependency |
| `GUI/src/sfi_reporter/llm_client.py` | Add `fetch_action_item_urls()` function |
| `GUI/src/sfi_reporter/tk_app.py` | Wire URL fetching into `_launch_llm_analysis()` |
