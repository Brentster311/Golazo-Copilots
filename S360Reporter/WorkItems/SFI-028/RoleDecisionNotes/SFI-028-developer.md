...
| File | Change |
|------|--------|
| `GUI/src/sfi_reporter/tk_app.py` | Rewrote `get_org_mapping()`, `get_service_owners()`, updated `do_refresh()` |
| `GUI/tests/test_sfi_028.py` | New: 12 tests for Graph API integration |
| `GUI/tests/test_sfi_026.py` | Updated `TestGetOrgMappingMultiLevel` to use Graph API mocks |
...
- **PyInstaller build**: `S360Reporter.exe` builds successfully
