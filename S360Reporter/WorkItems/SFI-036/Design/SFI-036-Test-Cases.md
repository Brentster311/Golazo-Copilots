...
- **Steps**: Grep for `sfi_reporter.tk_app` in `GUI/src/`
...
- **Steps**: Grep for `sfi_reporter.tk_app` in `GUI/tests/`
- **Expected**: Zero matches
...
- **Expected**: `GUI/src/sfi_reporter/tk_app.py` does not exist
