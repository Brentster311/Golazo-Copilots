...
S360Reporter already persists the "re-apply filter" preference to `%TEMP%/GUI/settings.json`. Reusing this file for LLM config avoids introducing a new storage mechanism. Keys: `llm_endpoint`, `llm_deployment`, `llm_api_version`.
