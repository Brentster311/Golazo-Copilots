...
### PyInstaller Build
- **Command**: `python -m PyInstaller --onefile --name S360Reporter --hidden-import sfi_reporter.query_builder --hidden-import sfi_reporter.eta_logic --hidden-import llm_extender --hidden-import llm_extender.exceptions --hidden-import llm_extender.url_fetcher --hidden-import llm_extender.client --hidden-import llm_extender.config --hidden-import llm_extender.auth --hidden-import llm_extender.providers --hidden-import llm_extender.discovery --paths C:\...\LLMExtender src/sfi_reporter/tk_app.py`
- **Note**: Added `--hidden-import llm_extender.discovery` for the new auto-detect feature
- **Result**: Build completed successfully
- **Artifact**: `dist/S360Reporter.exe` (~47 MB)
- **Package**: `dist/S360Reporter.zip` (~47 MB)
