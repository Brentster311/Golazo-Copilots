...
accia-s360 is a client library — caching strategy belongs to consumers. S360Reporter already has its own cache layer. Adding caching here would create staleness issues and complicate the API.
