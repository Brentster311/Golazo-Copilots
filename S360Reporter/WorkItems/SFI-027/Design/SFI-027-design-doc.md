...
## Problem Statement
SFI-026 (multi-level owner grouping in S360Reporter) failed because S360 provides no reliable API for org hierarchy traversal:
...
## Stakeholders
- **Consumers**: S360Reporter (SFI-026), any future accia-s360 consumer needing org data
