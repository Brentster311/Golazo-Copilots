...
- `GUI/src/sfi_reporter/tk_app.py`: `ItemDetailsModal._build_content()` — `group_titles` dict
- `GUI/tests/test_detail_modal_colors.py`: Current weak test file (to be replaced)
