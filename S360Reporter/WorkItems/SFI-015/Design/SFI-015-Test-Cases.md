...
- **Application**: S360Reporter Desktop (tkinter)
...
**Preconditions**:
1. S360Reporter app is running with detail modal open
...
**Preconditions**:
1. S360Reporter is running with items loaded
...
**Preconditions**:
1. S360Reporter is running with an embedded detail view option (if supported)
...
**Preconditions**:
- S360Reporter supports dark theme mode
