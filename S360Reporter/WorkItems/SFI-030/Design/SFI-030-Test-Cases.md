...
**Verify**: Run `pytest GUI/tests/ -m "not live" --tb=short -q`
...
**Verify**: `pyinstaller --clean S360Reporter.spec`
**Expected**: `S360Reporter.exe` produced without errors.

## TC-05: tk_app.py is under 100 lines

**Verify**: `wc -l GUI/src/sfi_reporter/tk_app.py`
**Expected**: < 100 lines.
