...
### Files Changed
- `GUI/src/sfi_reporter/data.py` - Column cache functions
- `GUI/src/sfi_reporter/cache.py` - Clear cache includes column metadata
- `GUI/tests/test_data.py` - 8 new column cache tests
- `GUI/tests/test_cache.py` - 1 new clear cache test
