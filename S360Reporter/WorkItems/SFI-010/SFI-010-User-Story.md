...
- **Assumption (explicit)**: Metadata cache can be stored alongside the existing data cache in `$TEMP/GUI/`

## Acceptance Criteria

- [ ] **AC1**: Column metadata cache file exists at `$TEMP/GUI/column_metadata.json`
