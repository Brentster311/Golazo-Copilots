...
| `GUI/README.md` | Added "🤖 Analyze with LLM" feature description + "LLM Analysis Setup" section with env var instructions |
...
- ✅ Storage path `%LOCALAPPDATA%\GUI\\analyses\` matches `llm_storage.get_analyses_dir()`
