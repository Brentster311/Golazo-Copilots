...
- **As a**: S360Reporter user (manager or IC)
...
- **So that**: I can interact with a Copilot-powered chat assistant directly within S360Reporter without needing to configure Azure OpenAI endpoints
...
- **Confirmed**: The side panel matches the existing S360Reporter system/light theme rather than the dark theme from ghcpsdk.
...
- [ ] All existing S360Reporter tests that don't test removed LLM code continue to pass
