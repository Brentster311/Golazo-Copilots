...
| **Artifact** | `GUI/dist/S360Reporter.exe` |
| **Warnings** | Written to `build/GUI/warn-S360Reporter.txt` (standard PyInstaller warnings only) |

### Build Command

```bash
cd GUI
..\.venv\Scripts\python.exe -m PyInstaller --clean S360Reporter.spec
```
