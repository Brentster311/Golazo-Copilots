...
| File | Changes |
|------|---------|
| `GUI/src/sfi_reporter/tk_app.py` | OrgAncestry, serialization, get_org_mapping, get_service_owners, aggregate_by_owner, collect_services_for_owner, do_refresh, tree population, drill-down |
| `GUI/tests/test_sfi_029.py` | 13 new tests (TDD) |
| `GUI/tests/test_sfi_026.py` | Updated for path-based OrgAncestry (18 tests) |
| `GUI/tests/test_sfi_028.py` | Simplified to dict-return test (1 test) |
| `GUI/tests/test_sfi_026_live.py` | Updated live tests for path model (30 tests) |
