...
Implemented Column Toggle UI for the drill-down modal in the S360Reporter Tkinter application.
...
- `GUI/src/sfi_reporter/tk_app.py` - Added constants, helper functions, ColumnSelectorDialog, modified DetailModal
- `GUI/tests/test_tk_app.py` - Added TestColumnToggle class with 7 tests (done in prior session)
