...
Add a "Service Summary (by Owner)" section to the S360Reporter that groups services by their DevOwner, enabling managers to see action item distribution across their direct reports.

## Problem Statement

Currently, the S360Reporter shows service-level and program-level summaries, but managers cannot easily see which team members are responsible for the most action items. To understand team member workload, managers must manually correlate services to people.
...
| Developer | S360Reporter Team | Implementation |
