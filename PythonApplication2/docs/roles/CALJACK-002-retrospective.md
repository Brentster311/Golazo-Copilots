...
| File | Change |
|------|--------|
| `.github/copilot-instructions.md` | ? Added "Retrospective auto-trigger rules" section |
| `.github/copilot-instructions.md` | ? Added "Visual verification by Project Owner (if UI story)" to DoD checklist |
| `.github/roles/developer.md` | ? Added "UI Verification" section |
| `.github/roles/developer.md` | ? Updated success criteria for UI stories |
