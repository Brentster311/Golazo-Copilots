...
def test_capability_registry_uses_canonical_location() -> None:
    assert (PROJECT_ROOT / "WorkItems" / "capabilities.yaml").exists()
    assert not (PROJECT_ROOT / "capabilities.yaml").exists()
