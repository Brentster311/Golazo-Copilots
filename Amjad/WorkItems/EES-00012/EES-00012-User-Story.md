...
- **I want:** the GUI to display v2 rules showing THEN and optional ELSE branches with their output entity types
- **So that:** I can visually review, confirm, and understand the diagnostic branching in extracted rules
- **Out of scope:**
